...
export function NavbarSolid() {
  ...
  const links = [
    { href: "/services", label: "Services" },
    {
      ...
      label: "Industrial Supply, Logistics & Distribution",
    },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link
                href="/"
                className={`text-sm font-medium transition-colors ${location === "/" ? "text-white" : "text-slate-300 hover:text-white"}`}
              >
                Home
              </Link>
              ...
              <div className="relative" ref={aboutRef}>
                <button
                  ...
                  className={`flex items-center gap-1 text-sm font-medium transition-colors ${
                    location === "/about" || location === "/leadership"
                      ? "text-white"
        ...
        {isOpen && (
          <div className="md:hidden bg-slate-800">
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="px-3 py-2 text-slate-400 text-xs uppercase tracking-wider">
                About
              </div>
              <Link
                href="/about"
                className="block px-6 py-3 text-white text-base font-medium hover:bg-slate-700 rounded-md transition-colors"
                onClick={() => setIsOpen(false)}
              >
                Company Overview
              </Link>
