...
export function Navbar() {
  ...
  return (
    <>
      {/* Main Navigation - Transparent overlay on hero */}
            ...
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <span className="font-display font-bold text-lg text-white leading-tight tracking-tight">
                    G&E
                  </span>
                  <span className="text-[10px] text-white/80 uppercase tracking-wider leading-tight">
                    Industrial<br/>Supplies, Inc.
                  </span>
                </div>
              </Link>
            </div>
